...
#. Type `print 'hello'`. Python executes this statement, which has the effect
   ...
   Now make a script named `hello.py` containing the following:

   .. sourcecode:: python

       print 'Hello there world!'

    Run the script and make note of what happens.  Now remove the `print`
   ...
   Run it again and notice what happens.  If you see nothing at all the 2nd
   time, everything is working as it should.
