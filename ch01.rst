...
In this book you can also write programs using a unique **activecode** interpreter that allows you to execute Python code right
...
The examples in this book use a mixture of the standard Python  interpreter, scripts, and activecode.  You
