...
#. Lists can be used to represent mathematical *vectors*.  In this exercise
   ...
   code to make the doctests for each function pass.
...
#. Write functions ``row_times_column`` and ``matrix_mult``:
   ...
   above.
#. Create a new module named ``numberlists.py`` and add the following functions
   to the module:
...
#. Add a function ``multiples_of(num, numlist)`` to ``numberlists.py`` that
   ...
   multiples of ``num``.  Add your own doctests and use TDD to develope this
   function.
#. Given:
