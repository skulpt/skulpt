...
extensions = ['video','activecode', 'visualizer']
...
# of the sidebar.
html_logo = "_static/thinkcspy.png" 
...
latex_documents = [
  ('index', 'thinkcspy3.tex', u'How to Think Like a Computer Scientist: Learning with Python Documentation',
