...
try:
    ...
    print "+-----------------------------------------------------------------------------+"
    print "GitPython is not installed for Python 2.7"
...
def upload():
    ...
    ret = os.system("python2.7 ~/Desktop/3rdparty/google_appengine/appcfg.py update doc")
    if ret != 0:
        print "Couldn't upload."
        raise SystemExit()

def doctest():
    ret = os.system("python2.7 ~/Desktop/3rdparty/google_appengine/dev_appserver.py -p 20710 doc")
