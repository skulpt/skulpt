...
class NonlocalTests(unittest.TestCase):
    ...
    def test_write_through_intermediate_cells(self):
        def outer():
            x = 1
            def middle():
                y = 2
    ...
    def test_generator_write_through_intermediate_cells(self):
        def outer():
            x = 1
            def middle():
                y = 2
    ...
    def test_write_before_enclosing_assignment(self):
        def outer():
            def middle():
                y = 2
                def inner():
    ...
    def test_delete_and_rebind_through_intermediate_cells(self):
        def outer():
            x = 1
            def middle():
                y = 2
            ...
            with self.assertRaises(UnboundLocalError):
                x
            self.assertRaises(NameError, delete)
            bind()
            return x
        self.assertEqual(outer(), 2)

    def test_unbound_cell_shadows_outer_binding(self):
        x = 10
        def capture():
            return x
        def middle():
            ...
            inner()
            x = 1
        self.assertRaises(NameError, middle)
