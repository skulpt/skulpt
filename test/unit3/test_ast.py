...
class AST_Tests(unittest.TestCase):
    ...
    # @unittest.skip("weakref doesn't exist in skulpt")
    ...
    def test_classattrs(self):
        ...
        # TODO: Bytes not working in skulpt just yet
        ...
        # TODO: Ellipsis not working in skulpt just yet
...
class ASTValidatorTests(unittest.TestCase):
    ...
    # TODO: Removed keyword-only asterisk before exc
    ...
    # @unittest.skip("OS Path is not setup")
...
class ConstantTests(unittest.TestCase):
    ...
    # @unittest.skip("dis doesn't exist in skulpt")
