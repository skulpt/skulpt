...
class BasicTestMappingProtocol:
...
# tests moved from test_dict.py
class GeneralMappingTests(BasicTestMappingProtocol, unittest.TestCase):
    type2test = dict

class Dict(dict):
    pass

class SubclassMappingTests(BasicTestMappingProtocol, unittest.TestCase):
    type2test = Dict
