...
class TestSet(TestJointOps):
    ...
    # XXX disabled until weakref works
    def XXXtest_weakref(self):
...
class TestFrozenSet(TestJointOps):
    ...
    # disabled since it depends on CPython specific hash algorithm
...
class TestVariousIteratorArgs(unittest.TestCase):
    ...
    def test_constructor(self):
        for cons in (set, frozenset):
            for s in ("123", "", range(100), ('do', 1.2), xrange(2000,2200,5)):
    ...
    def test_inline_methods(self):
        s = set('november')
        for data in ("123", "", range(100), ('do', 1.2), xrange(2000,2200,5), 'december'):
