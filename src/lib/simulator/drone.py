...
class Drone():
    ...
    g = 9.81  # 9.81m/s^2 
    I = np.array([[2.04016E-5, 0, 0],
                  [0, 1.56771E-5, 0],
                  [0, 0, 3.51779E-5]])  # inertia matrix of the drone in kgm3
    I = np.array([[1E-5, 0, 0],
                  [0, 1E-5, 0],
                  [0, 0, 1E-5]])
    b = 0.02  # drag coefficient rotor blade, should be magnitudes smaller
    k = 0.214  # thrust coefficient in kg/rpm2, should be 9.14E-
