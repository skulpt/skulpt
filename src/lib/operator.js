import {
    ...
    sequenceGetIndexOf,
    sequenceSetItem,
    sequenceContains } from '../abstract'
...
var $builtinmodule = function (name) {
    ...
    // Note: numberUnaryOp(obj, 'Invert') looks for the function nb$invert() on obj.
    ...
    mod.inv = new Sk.builtin.func(function (obj) {
        return numberUnaryOp(obj, 'Invert');
    });
    mod.__inv__ = mod.inv;
    mod.invert = mod.inv;
