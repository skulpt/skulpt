...
export class timSort {
    ...
    */
    ...
    count_run(a) {
        ...
        */
        ...
        return {"run": new listSlice(a.list, a.base, n), "descending": descending};
    }
    ...
    sort() {
        ...
        */
        ...
        var cr;
        var sorted;
        var remaining = new listSlice(this.list, 0, this.listlength);
        if (remaining.len < 2) {
            return;
        }
    ...
    */
    ...
    merge_at(i) {
        ...
        this.pending[i] = new listSlice(this.list, a.base, a.len + b.len);
...
class listSlice {
    ...
    copyitems() {
        ...
        return new listSlice(new list(this.list.v.slice(start, stop)), 0, this.len);
    }
