...
// removed RegExp uneval to avoid inhibiting closure opts (though really,
// should actually not even have this in the runtime)
/*
...
goog.exportSymbol("Sk.uneval", Sk.uneval);
