...
class Compiler {
     ...
     */
    constructor(filename, st, flags, canSuspend, sourceCodeForAnnotation) {
     ...
     */
    outputInterruptTest() { // Added by RNL
        var output = "";
    ...
    ctuplelistorset = function(e, data, tuporlist) {
        var i;
        var items;
    ...
    ccompgen(type, tmpname, generators, genIndex, value, key, e) {
    ...
    outputFinallyCascade(thisFinally) {
        var nextFinally;
     ...
     *
     */
    buildcodeobj(n, coname, decorator_list, args, callback, class_for_super) {
    ...
    */
    enterScope(name, key, lineno, canSuspend) {
        var scopeName;
